                ...
                >
                    <Box width="858px" px="4" mr={width <= MOBILE_BREAKPOINT ? 0 : 5}>
                                ...
                                <Box alignItems="flex-start" justifyContent="center" mt="2">
                                    ...
                                    >
                                        <Box dir="row" alignItems="center">
                                            ...
                                            <Icon.Material name="star" size={24} color="yellow.4"/>
                                            <Icon.Material name="star" size={24} color="yellow.4"/>
                                            <Icon.Material name="star_half" size={24} color="yellow.4"/>
                                            <Icon.Material name="star_outline" size={24} color="yellow.4"/>
                        ...
                        <Box mt="4">
                            <ListTabs
                                tabs={tabs}
                                onChange={(target) => setSelectedTab(target as StartChallengeTabs)}
                            />
                        </Box>
                        {
                            (selectedTab === StartChallengeTabs.DESCRIPTION || !isMobile) && (
                                <StartDescriptionTab/>
                            )
                        }
                    </Box>
